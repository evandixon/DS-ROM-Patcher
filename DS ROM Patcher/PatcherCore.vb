...
#End Region
    ...
    Public MustOverride Function RunPatch(modpackDirectory As String, modpack As ModpackInfo, mods As IEnumerable(Of ModJson), Optional destinationPath As String = Nothing) As Task
End Class
